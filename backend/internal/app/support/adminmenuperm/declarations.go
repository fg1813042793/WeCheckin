...
func Declarations(enableExam bool) []Declaration {
	items := []Declaration{
		...
		{Key: "admin:menu:event", Name: "赛事活动", Path: "/event", Perms: "event:list", Icon: "TrophyBase", Sort: 13, Type: TypeMenu},
		{Key: "admin:menu:survey", Name: "问卷调查", Path: "/survey", Perms: "survey:list", Icon: "List", Sort: 14, Type: TypeDirectory},
		{Key: "admin:menu:question-exam", Name: "问卷考试", Path: "/question-exam", Perms: "question-bank:list", Icon: "Collection", Sort: 16, Type: TypeDirectory},
