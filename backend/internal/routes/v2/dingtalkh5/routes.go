...
func Register(h *server.Hertz) {
	...
	auth.GET("/workflows/instances/:id/form-revisions", routeparam.WithQueryID(workflowHandler.ListFormRevisions))
	auth.POST("/workflows/instances/:id/form-revisions/preview", routeparam.WithBodyOrFormID(workflowHandler.PreviewCompletedFormRevision))
	auth.POST("/workflows/instances/:id/form-revisions", routeparam.WithBodyOrFormID(workflowHandler.CreateCompletedFormRevision))
	auth.GET("/workflows/form-revisions/:id", routeparam.WithQueryID(workflowHandler.GetFormRevision))
	auth.POST("/workflows/form-revisions/:id/cancel", routeparam.WithBodyOrFormID(workflowHandler.CancelCompletedFormRevision))
	auth.POST("/workflows/form-revision-tasks/:id/complete", routeparam.WithBodyOrFormID(workflowHandler.CompleteFormRevisionTask))
