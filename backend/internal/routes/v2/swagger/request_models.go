...
type UserFeedbackStatusRequest struct {
	...
	Status string `json:"status" validate:"required" enums:"pending,processing,resolved,closed" example:"resolved"`
	...
	Version uint64 `json:"version" validate:"required" example:"3"`
	// RequestID 是客户端生成的状态更新幂等请求标识。
	RequestID string `json:"requestId" validate:"required" example:"8f9f4f33-f9b8-4f2f-9b26-f83c33d4f17f"`
}
