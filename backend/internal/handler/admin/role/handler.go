...
func (h *AdminRoleHandler) AddRole(ctx context.Context, c *app.RequestContext) {
	...
	if _, err := roleservice.AddWithAssignmentsContext(ctx, admin.ID, name, remark, c.ClientIP(), sort, dataScope, allowAdminLogin, adminPermissionKeys, adminAPIPermissionKeys, deptIDs, clientMenuKeys, dingtalkH5MenuKeys, clientAPIPermissionKeys, dingtalkH5APIPermissionKeys); err != nil {
...
func (h *AdminRoleHandler) EditRole(ctx context.Context, c *app.RequestContext) {
	...
	if err := roleservice.EditWithAssignmentsContext(ctx, admin.ID, uint(id), name, remark, c.ClientIP(), sort, status, dataScope, allowAdminLogin, adminPermissionKeys, adminAPIPermissionKeys, deptIDs, clientMenuKeys, dingtalkH5MenuKeys, clientAPIPermissionKeys, dingtalkH5APIPermissionKeys); err != nil {
