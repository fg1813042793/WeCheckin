...
func ClientAPIDeclarations() []Declaration {
	return []Declaration{
		...
		clientAPI("client:api:upload:create", "文件上传接口", "upload:create", "client:api-category:user", "POST", "/api/v2/uploads", 50),
...
func ClientRouteDeclarations() []RouteDeclaration {
	return []RouteDeclaration{
		...
		{Method: "POST", Path: "/api/v2/uploads", PermissionKey: "client:api:upload:create"},
		...
		{Method: "GET", Path: "/api/v2/me/event-catalog", PermissionKey: "client:api:event:view"},
		{Method: "GET", Path: "/api/v2/me/event-catalog/:id", PermissionKey: "client:api:event:view"},
		...
		{Method: "DELETE", Path: "/api/v2/workflows/drafts/:definitionId", PermissionKey: "client:api:workflow:start"},
...
func DingTalkH5APICategories() []Category {
	return []Category{
		...
		{Key: "dingtalk_h5:api-category:feedback", Name: "用户反馈", Platform: "dingtalk_h5", Sort: 80},
	}
}
...
func DingTalkH5APIDeclarations() []Declaration {
	return []Declaration{
		...
		dingtalkAPI("dingtalk_h5:api:workflow:form-revision-create", "发起完成后表单修订接口", "workflow:form-revision-create", "dingtalk_h5:api-category:workflow", "POST", "/api/v2/dingtalk/h5/workflows/instances/:id/form-revisions", 81),
		dingtalkAPI("dingtalk_h5:api:workflow:form-revision-handle", "处理完成后表单修订接口", "workflow:form-revision-handle", "dingtalk_h5:api-category:workflow", "POST", "/api/v2/dingtalk/h5/workflows/form-revision-tasks/:id/complete", 82),
		...
		dingtalkAPI("dingtalk_h5:api:feedback:list", "用户反馈列表接口", "feedback:list", "dingtalk_h5:api-category:feedback", "GET", "/api/v2/dingtalk/h5/user-feedbacks", 10),
		dingtalkAPI("dingtalk_h5:api:feedback:create", "用户反馈创建接口", "feedback:create", "dingtalk_h5:api-category:feedback", "POST", "/api/v2/dingtalk/h5/user-feedbacks", 20),
		dingtalkAPI("dingtalk_h5:api:feedback:detail", "用户反馈详情接口", "feedback:detail", "dingtalk_h5:api-category:feedback", "GET", "/api/v2/dingtalk/h5/user-feedbacks/:id", 30),
		dingtalkAPI("dingtalk_h5:api:feedback:supplement", "用户反馈补充接口", "feedback:supplement", "dingtalk_h5:api-category:feedback", "POST", "/api/v2/dingtalk/h5/user-feedbacks/:id/supplements", 40),
	}
}
...
func DingTalkH5RouteDeclarations() []RouteDeclaration {
	...
	routes = append(routes,
		...
		RouteDeclaration{Method: "DELETE", Path: "/api/v2/dingtalk/h5/workflows/drafts/:definitionId", PermissionKey: "dingtalk_h5:api:workflow:start"},
		RouteDeclaration{Method: "GET", Path: "/api/v2/dingtalk/h5/workflows/instances/:id", PermissionKey: "dingtalk_h5:api:workflow:view"},
		RouteDeclaration{Method: "GET", Path: "/api/v2/dingtalk/h5/workflows/instances/:id/form-revisions", PermissionKey: "dingtalk_h5:api:workflow:view"},
		RouteDeclaration{Method: "POST", Path: "/api/v2/dingtalk/h5/workflows/instances/:id/form-revisions/preview", PermissionKey: "dingtalk_h5:api:workflow:form-revision-create"},
		RouteDeclaration{Method: "GET", Path: "/api/v2/dingtalk/h5/workflows/form-revisions/:id", PermissionKey: "dingtalk_h5:api:workflow:view"},
		RouteDeclaration{Method: "POST", Path: "/api/v2/dingtalk/h5/workflows/form-revisions/:id/cancel", PermissionKey: "dingtalk_h5:api:workflow:form-revision-create"},
		RouteDeclaration{Method: "GET", Path: "/api/v2/dingtalk/h5/workflows/tasks", PermissionKey: "dingtalk_h5:api:workflow:view"},
		RouteDeclaration{Method: "GET", Path: "/api/v2/dingtalk/h5/workflows/summary/definitions", PermissionKey: "dingtalk_h5:api:workflow:summary"},
		RouteDeclaration{Method: "GET", Path: "/api/v2/dingtalk/h5/workflows/summary/definitions/:id", PermissionKey: "dingtalk_h5:api:workflow:summary"},
