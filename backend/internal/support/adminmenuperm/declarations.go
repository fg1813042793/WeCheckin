...
func Declarations(enableExam bool) []Declaration {
	items := []Declaration{
		...
		{Key: "admin:menu:scheduled-task", Name: "定时任务", Path: "/scheduled-task", Perms: "scheduled-task:list", Icon: "Timer", Sort: 18, Type: TypeDirectory},
		{Key: "admin:menu:notification", Name: "通知管理", Path: "/notifications", Perms: "notification:list", Icon: "Bell", Sort: 19, Type: TypeMenu},
		{Key: "admin:menu:swagger", Name: "接口文档", Path: "/swagger-docs", Perms: "swagger:view", Icon: "Document", Sort: 19, Type: TypeMenu},
		{Key: "admin:menu:user-feedback", Name: "用户反馈", Path: "/user-feedbacks", Perms: "user-feedback:list", Icon: "ChatDotRound", Sort: 20, Type: TypeMenu},
		{Key: "admin:menu:user-feedback:list", Name: "用户反馈查看", Perms: "user-feedback:list", Sort: 1, Type: TypeButton, ParentKey: "admin:menu:user-feedback"},
		{Key: "admin:menu:user-feedback:handle", Name: "用户反馈处理", Perms: "user-feedback:handle", Sort: 2, Type: TypeButton, ParentKey: "admin:menu:user-feedback"},
		...
		{Key: "admin:menu:scheduled-task:tasks", Name: "任务管理", Path: "/scheduled-task/tasks", Perms: "scheduled-task:list", Sort: 1, Type: TypeMenu, ParentKey: "admin:menu:scheduled-task"},
		{Key: "admin:menu:scheduled-task:runs", Name: "运行记录", Path: "/scheduled-task/runs", Perms: "scheduled-task:run:list", Sort: 2, Type: TypeMenu, ParentKey: "admin:menu:scheduled-task"},
		{Key: "admin:menu:scheduled-task:workers", Name: "执行节点", Path: "/scheduled-task/workers", Perms: "scheduled-task:worker:list", Sort: 3, Type: TypeMenu, ParentKey: "admin:menu:scheduled-task"},
		...
		{Key: "admin:menu:scheduled-task:list", Name: "定时任务查看", Perms: "scheduled-task:list", Sort: 1, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:add", Name: "定时任务创建", Perms: "scheduled-task:add", Sort: 2, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:edit", Name: "定时任务编辑", Perms: "scheduled-task:edit", Sort: 3, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:delete", Name: "定时任务删除", Perms: "scheduled-task:delete", Sort: 4, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:status", Name: "定时任务启停", Perms: "scheduled-task:status", Sort: 5, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:run", Name: "立即运行", Perms: "scheduled-task:run", Sort: 6, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:http", Name: "配置 HTTP 任务", Perms: "scheduled-task:http", Sort: 7, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:shell", Name: "配置 Shell 任务", Perms: "scheduled-task:shell", Sort: 8, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:sql:read", Name: "配置 SQL 查询任务", Perms: "scheduled-task:sql:read", Sort: 9, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:sql:write", Name: "配置 SQL 写入任务", Perms: "scheduled-task:sql:write", Sort: 10, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:tasks"},
		{Key: "admin:menu:scheduled-task:run:list", Name: "运行记录查看", Perms: "scheduled-task:run:list", Sort: 1, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:runs"},
		{Key: "admin:menu:scheduled-task:run:retry", Name: "运行记录重试", Perms: "scheduled-task:run:retry", Sort: 2, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:runs"},
		{Key: "admin:menu:scheduled-task:run:cancel", Name: "运行记录取消", Perms: "scheduled-task:run:cancel", Sort: 3, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:runs"},
		{Key: "admin:menu:scheduled-task:worker:list", Name: "执行节点查看", Perms: "scheduled-task:worker:list", Sort: 1, Type: TypeButton, ParentKey: "admin:menu:scheduled-task:workers"},
		{Key: "admin:menu:notification:list", Name: "站内信查看", Perms: "notification:list", Sort: 1, Type: TypeButton, ParentKey: "admin:menu:notification"},
		{Key: "admin:menu:notification:read", Name: "站内信已读", Perms: "notification:read", Sort: 2, Type: TypeButton, ParentKey: "admin:menu:notification"},
		{Key: "admin:menu:notification:send", Name: "发送站内信", Perms: "notification:send", Sort: 3, Type: TypeButton, ParentKey: "admin:menu:notification"},
