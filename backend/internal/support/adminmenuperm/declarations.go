...
func Declarations(enableExam bool) []Declaration {
	items := []Declaration{
		...
		{Key: "admin:menu:workflow:notification:list", Name: "流程通知查看", Perms: "workflow:notification:list", Sort: 5, Type: TypeButton, ParentKey: "admin:menu:workflow:instances"},
		{Key: "admin:menu:workflow:notification:retry", Name: "流程通知重试", Perms: "workflow:notification:retry", Sort: 6, Type: TypeButton, ParentKey: "admin:menu:workflow:instances"},
