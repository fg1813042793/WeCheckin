...
type Task struct {
	ID                uint64    `json:"id" gorm:"primaryKey;column:id;index:idx_scheduled_tasks_poll_due,priority:4;comment:Task ID"`
	...
	Enabled           int       `json:"enabled" gorm:"column:enabled;index:idx_scheduled_tasks_due,priority:1;index:idx_scheduled_tasks_handler,priority:2;index:idx_scheduled_tasks_poll_due,priority:1;comment:Enabled status"`
	...
	NextRunAt         int64     `json:"nextRunAt" gorm:"column:next_run_at;index:idx_scheduled_tasks_due,priority:2;index:idx_scheduled_tasks_poll_due,priority:3;comment:Next schedule"`
	...
	DeletedAt         int64     `json:"deletedAt" gorm:"column:deleted_at;index:idx_scheduled_tasks_deleted;index:idx_scheduled_tasks_poll_due,priority:2;comment:Soft deletion time"`
...
type Run struct {
	ID                string    `json:"id" gorm:"size:64;primaryKey;column:id;index:idx_scheduled_runs_delivery_due,priority:4;comment:Run ID"`
	...
	Status            string    `json:"status" gorm:"size:24;column:run_status;index:idx_scheduled_task_runs_due,priority:1;index:idx_scheduled_task_runs_recovery,priority:1;index:idx_scheduled_runs_delivery_due,priority:1;comment:Run status"`
	...
	RedisMessageID    string    `json:"redisMessageId" gorm:"size:80;column:redis_message_id;index:idx_scheduled_runs_delivery_due,priority:2;comment:Redis message ID"`
	QueuedAt          int64     `json:"queuedAt" gorm:"column:queued_at;index:idx_scheduled_runs_delivery_due,priority:3;comment:Queue time"`
