...
type Survey struct {
	...
	DeptID       uint   `gorm:"column:create_dept_id;default:0" json:"deptId" form:"deptId"`
	CreateBy     uint   `gorm:"column:create_by;default:0" json:"createBy" form:"createBy"`
	UpdateBy     uint   `gorm:"column:update_by;default:0" json:"updateBy" form:"updateBy"`
	UpdateDeptID uint   `gorm:"column:update_dept_id;default:0" json:"updateDeptId" form:"updateDeptId"`
	AddTime      int64  `gorm:"column:add_time" json:"addTime" form:"addTime"`
	EditTime     int64  `gorm:"column:edit_time" json:"editTime" form:"editTime"`
