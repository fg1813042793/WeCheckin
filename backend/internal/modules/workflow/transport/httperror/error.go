...
var publicErrors = []publicError{
	...
	{workflowapp.ErrInstanceFormRevisionChanged, "流程表单已被更新，请重新打开后修改"},
	{workflowapp.ErrInstanceFormRevisionRequired, "流程表单版本不能为空"},
	{workflowapp.ErrInstanceFormRevisionDataRequired, "请至少修改一个表单字段"},
	{workflowapp.ErrInstanceFormRevisionReasonRequired, "请填写修改原因"},
	{workflowapp.ErrInstanceFormRevisionReasonTooLong, "修改原因不能超过500个字符"},
