...
-- ==================== news ====================
INSERT INTO `news` (`id`, `news_title`, `news_desc`, `news_status`, `news_cate_id`, `news_cate_name`, `news_order`, `news_vouch`, `news_content`, `news_qr`, `news_view_cnt`, `news_pic`, `news_forms`, `news_obj`, `create_by`, `update_by`, `create_dept_id`, `update_dept_id`, `add_time`, `edit_time`, `news_add_ip`, `news_edit_ip`, `created_at`, `updated_at`) VALUES
(1, 'WeCheckin 正式上线', 'WeCheckin 打卡签到系统正式发布上线', 1, '1', '公司新闻', 1, 1, '经过数月开发，WeCheckin 打卡签到系统正式上线了。\n\n本系统支持多种打卡模式，满足不同场景需求。', '', 120, '[]', '', '', 1, 1, 0, 0, 1780243200000, 1780243200000, '127.0.0.1', '127.0.0.1', NOW(), NOW()),
(2, '关于启用健康打卡的通知', '即日起全体员工需完成每日健康打卡', 1, '3', '通知公告', 2, 1, '为保障员工健康，即日起启用健康打卡功能。\n\n请各位同事每日上班前完成健康打卡。', '', 85, '[]', '', '', 1, 1, 0, 0, 1780243200000, 1780243200000, '127.0.0.1', '127.0.0.1', NOW(), NOW()),
(3, '行业动态：数字化办公新趋势', '数字化转型正在改变企业的办公方式', 1, '2', '行业动态', 3, 0, '随着数字化转型的深入，越来越多的企业开始采用数字化工具进行管理。\n\n打卡签到作为企业管理的基础环节，也在不断创新。', '', 210, '[]', '', '', 1, 1, 0, 0, 1780243200000, 1780243200000, '127.0.0.1', '127.0.0.1', NOW(), NOW());

-- ==================== enrolls ====================
-- 时间戳: 2026-05-01 ~ 2026-06-30
-- enroll_obj JSON: {"cover":["https://example.com/cover/1.jpg"],"desc":"每日运动打卡，健康生活"}
INSERT INTO `enrolls` (`id`, `enroll_title`, `enroll_status`, `enroll_cate_id`, `enroll_cate_name`, `enroll_start`, `enroll_end`, `enroll_day_cnt`, `enroll_order`, `enroll_vouch`, `enroll_forms`, `enroll_obj`, `enroll_join_forms`, `enroll_repeat`, `enroll_limit`, `enroll_qr`, `enroll_view_cnt`, `enroll_join_cnt`, `enroll_user_cnt`, `enroll_user_list`, `create_by`, `update_by`, `create_dept_id`, `update_dept_id`, `add_time`, `edit_time`, `enroll_add_ip`, `enroll_edit_ip`, `created_at`, `updated_at`) VALUES
(1, '每日运动打卡',   1, '1', '运动打卡', 1777564800000, 1782748800000, 61, 1, 1,
 ...
 0, 1, '', 150, 0, 0, '', 1, 1, 0, 0, 1777564800000, 1777564800000, '127.0.0.1', '127.0.0.1', NOW(), NOW()),
...
(2, '读书学习打卡',   1, '2', '学习打卡', 1777564800000, 1782748800000, 61, 2, 1,
 ...
 0, 3, '', 80, 0, 0, '', 1, 1, 0, 0, 1777564800000, 1777564800000, '127.0.0.1', '127.0.0.1', NOW(), NOW()),
...
(3, '早起打卡',       1, '1', '运动打卡', 1777564800000, 1779724800000, 31, 3, 1,
 ...
 0, 1, '', 200, 0, 0, '', 1, 1, 0, 0, 1777564800000, 1777564800000, '127.0.0.1', '127.0.0.1', NOW(), NOW()),
...
(4, '喝水打卡',       1, '3', '健康打卡', 1777564800000, 1782748800000, 61, 4, 0,
 ...
 '', 45, 0, 0, '', 1, 1, 0, 0, 1777564800000, 1777564800000, '127.0.0.1', '127.0.0.1', NOW(), NOW()),
...
(5, '周报提交打卡',   0, '4', '工作打卡', 1777564800000, 1782748800000, 61, 5, 0,
 ...
 '', 30, 0, 0, '', 1, 1, 0, 0, 1777564800000, 1777564800000, '127.0.0.1', '127.0.0.1', NOW(), NOW());
...
-- ==================== logs ====================
INSERT INTO `logs` (`id`, `log_type`, `log_content`, `create_by`, `update_by`, `create_dept_id`, `update_dept_id`, `log_admin_name`, `log_admin_desc`, `add_time`, `edit_time`, `log_add_ip`, `created_at`, `updated_at`) VALUES
(1, 1, '管理员登录系统',       1, 1, 0, 0, 'admin',   '超级管理员', 1780243200000, 1780243200000, '127.0.0.1', NOW(), NOW()),
(2, 1, '管理员登录系统',       2, 2, 0, 0, 'manager', '普通管理员', 1780243200000, 1780243200000, '192.168.1.1', NOW(), NOW()),
(3, 2, '新增打卡项目: 每日运动打卡', 1, 1, 0, 0, 'admin',   '超级管理员', 1777564800000, 1777564800000, '127.0.0.1', NOW(), NOW()),
(4, 2, '新增打卡项目: 早起打卡',     1, 1, 0, 0, 'admin',   '超级管理员', 1777564800000, 1777564800000, '127.0.0.1', NOW(), NOW()),
(5, 3, '发布新闻: WeCheckin 正式上线', 1, 1, 0, 0, 'admin', '超级管理员', 1780243200000, 1780243200000, '127.0.0.1', NOW(), NOW());
