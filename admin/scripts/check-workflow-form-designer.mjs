...
const requirements = [
  ...
  [designerSource, 'const permissionsNormalized = normalizeWorkflowCalculationPermissions(data.draft)', '加载历史草稿时未修正计算字段权限'],
  [designerSource, "access: field.type === 'calculation' ? 'read'", '新增计算字段时未默认为只读权限'],
  [designerSource, 'normalizeWorkflowCalculationPermissions(detail.value.draft)', '保存草稿前未修正计算字段权限'],
