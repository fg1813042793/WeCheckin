...
assert.match(workflowCenter, /\.workflow-center__filter-field--date\s*\{[^}]*min-width:\s*280px;[^}]*flex:\s*0 0 280px;[^}]*max-width:\s*280px;/)
...
assert.match(workflowSummary, /\.workflow-summary__filter-action,\s*:deep\(\.workflow-summary__filter-action\)\s*\{[^}]*min-width:\s*64px;[^}]*height:\s*36px;[^}]*min-height:\s*36px;[^}]*font-size:\s*13px;/)
